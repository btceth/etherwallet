<footer class="container-fluid">
  <div class="container">
    ...
    <p>An open source, javascript, client-side tool for generating Ethererum Wallets & sending transactions.开源的Javascript客户端工具，用于生产以太坊钱包和发送交易。由 Created by <a href="https://github.com/kvhnuke" target="_blank">kvhnuke</a> and 和<a href="https://github.com/tayvano" target="_blank">tayvano</a>.创建。</p>
    <p class="wrap"> Donations greatly appreciated:捐赠地址： <span class="mono">0x7cB57B5A97eAbe94205C07890BE4c1aD31E486A8</span> </p>
    <p>
    URLs:
